  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-[#0F4C81] to-[#3A6B35] px-6 py-24">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-8 max-w-2xl text-base leading-8 text-white/90 sm:text-lg">
        ...
        <div className="mt-12 flex flex-col justify-center gap-4 sm:flex-row">
          ...
          <Link
            href="/#contacto"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-4 font-semibold text-[#0F4C81] transition hover:scale-105"
          >
          ...
          <Link
            href="/#contacto"
            className="inline-flex items-center justify-center gap-2 rounded-full border border-white px-8 py-4 font-semibold text-white transition hover:bg-white hover:text-[#0F4C81]"
          >
