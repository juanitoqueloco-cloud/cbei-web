export default function Hero() {
  return (
    <main className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-white pt-24">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-10 top-20 h-72 w-72 rounded-full bg-green-100 blur-3xl opacity-40"></div>
        <div className="absolute right-10 top-40 h-80 w-80 rounded-full bg-pink-100 blur-3xl opacity-40"></div>
      </div>
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-16 px-6 py-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <h1 className="mt-8 text-5xl font-extrabold leading-tight text-[#3A6B35] lg:text-6xl">
  Tu bienestar
  <br />
  comienza <span className="text-[#C2185B]">aquí.</span>
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <button className="rounded-full bg-[#0F4C81] px-8 py-4 font-semibold text-white transition hover:scale-105 hover:bg-[#0b3960]">
              Agendar cita
            </button>

            <button className="rounded-full border-2 border-[#3A6B35] px-8 py-4 font-semibold text-[#3A6B35] transition hover:bg-[#3A6B35] hover:text-white">
              Nuestros servicios
            </button>
        ...
        <div className="flex justify-center">
          ...
          <div className="relative flex h-[520px] w-[420px] items-center justify-center overflow-hidden rounded-[40px] bg-gradient-to-br from-[#EAF4E5] to-[#FCE7F3] shadow-2xl">

            <div className="absolute top-16 h-28 w-28 rounded-full bg-white/60 blur-sm"></div>
